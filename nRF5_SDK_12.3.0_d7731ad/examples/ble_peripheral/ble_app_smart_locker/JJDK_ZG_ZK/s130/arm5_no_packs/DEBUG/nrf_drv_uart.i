...
#line 41 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.h"
...
typedef enum
{
#line 137 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\hal\\nrf_uart.h"
...
typedef enum
{
    NRF_UART_PARITY_EXCLUDED = (0UL) << (1UL),  
    NRF_UART_PARITY_INCLUDED = (7UL) << (1UL),  
} nrf_uart_parity_t;
...
#line 58 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.h"




#line 63 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.h"
#line 64 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.h"
...
#line 89 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.h"




#line 110 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.h"
...
#line 200 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.h"
...
#line 43 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\libraries\\util\\nrf_assert.h"
...
#line 44 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
...
#line 45 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\hal\\nrf_gpio.h"
...
#line 46 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
...
#line 47 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
...
#line 60 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\libraries\\log\\nrf_log_ctrl.h"
...
#line 61 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"

#line 73 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
    
#line 80 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
...
#line 136 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
    { nrf_uart_baudrate_set(p_instance ->reg . p_uart, p_config->baudrate); nrf_uart_configure(p_instance ->reg . p_uart, p_config->parity, p_config->hwfc); nrf_uart_txrx_pins_set(p_instance ->reg . p_uart, p_config->pseltxd, p_config->pselrxd); if (p_config->hwfc == NRF_UART_HWFC_ENABLED) { if (p_config->pselcts != 0xFFFFFFFF) { nrf_gpio_cfg_input(p_config->pselcts, NRF_GPIO_PIN_NOPULL); } if (p_config->pselrts != 0xFFFFFFFF) { nrf_gpio_pin_set(p_config->pselrts); nrf_gpio_cfg_output(p_config->pselrts); } nrf_uart_hwfc_pins_set(p_instance ->reg . p_uart, p_config->pselrts, p_config->pselcts); } }
#line 155 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
}

static __inline void interrupts_enable(const nrf_drv_uart_t * p_instance, uint8_t interrupt_priority)
{
    
#line 171 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
...
#line 179 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
}

static __inline void interrupts_disable(const nrf_drv_uart_t * p_instance)
{
    
#line 191 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
    { nrf_uart_int_disable(p_instance ->reg . p_uart, NRF_UART_INT_MASK_RXDRDY | NRF_UART_INT_MASK_TXDRDY | NRF_UART_INT_MASK_ERROR | NRF_UART_INT_MASK_RXTO); nrf_drv_common_irq_disable(nrf_drv_get_IRQn((void *)p_instance ->reg . p_uart)); }
#line 199 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
...
#line 219 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
    { txd = nrf_uart_tx_pin_get(p_instance ->reg . p_uart); rxd = nrf_uart_rx_pin_get(p_instance ->reg . p_uart); rts = nrf_uart_rts_pin_get(p_instance ->reg . p_uart); cts = nrf_uart_cts_pin_get(p_instance ->reg . p_uart); nrf_uart_txrx_pins_disconnect(p_instance ->reg . p_uart); nrf_uart_hwfc_pins_disconnect(p_instance ->reg . p_uart); }
#line 228 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
...
static __inline void uart_enable(const nrf_drv_uart_t * p_instance)
{
    ...
    { nrf_uart_enable(p_instance ->reg . p_uart); };
}

static __inline void uart_disable(const nrf_drv_uart_t * p_instance)
{
    
    { nrf_uart_disable(p_instance ->reg . p_uart); };
}

ret_code_t nrf_drv_uart_init(const nrf_drv_uart_t * p_instance, nrf_drv_uart_config_t const * p_config,
                             nrf_uart_event_handler_t event_handler)
{
    if (0) { if (p_config) { } else { assert_nrf_callback((uint16_t)266, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };
...
#line 403 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"

ret_code_t nrf_drv_uart_tx(const nrf_drv_uart_t * p_instance, uint8_t const * const p_data, uint8_t length)
{
    uart_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state == NRF_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)407, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };
    if (0) { if (length>0) { } else { assert_nrf_callback((uint16_t)408, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };
    if (0) { if (p_data) { } else { assert_nrf_callback((uint16_t)409, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };

    ret_code_t err_code;
    
    
#line 424 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
...
ret_code_t nrf_drv_uart_rx(const nrf_drv_uart_t * p_instance, uint8_t * p_data, uint8_t length)
{
    ...
    if (0) { if (m_cb[p_instance ->drv_inst_idx]. state == NRF_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)597, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };
    if (0) { if (length>0) { } else { assert_nrf_callback((uint16_t)598, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };

    ret_code_t err_code;

    
#line 613 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
...
void nrf_drv_uart_rx_enable(const nrf_drv_uart_t * p_instance)
{
    ...
    { if (!m_cb[p_instance ->drv_inst_idx]. rx_enabled) { rx_enable(p_instance); m_cb[p_instance ->drv_inst_idx]. rx_enabled = 1; } }
#line 690 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
}
...
void nrf_drv_uart_rx_disable(const nrf_drv_uart_t * p_instance)
{
    ...
    { nrf_uart_task_trigger(p_instance ->reg . p_uart, NRF_UART_TASK_STOPRX); m_cb[p_instance ->drv_inst_idx]. rx_enabled = 0; }
...
uint32_t nrf_drv_uart_errorsrc_get(const nrf_drv_uart_t * p_instance)
{
    ...
    { nrf_uart_event_clear(p_instance ->reg . p_uart, NRF_UART_EVENT_ERROR); errsrc = nrf_uart_errorsrc_get_and_clear(p_instance ->reg . p_uart); }
...
void nrf_drv_uart_rx_abort(const nrf_drv_uart_t * p_instance)
{
    ...
    { nrf_uart_int_disable(p_instance ->reg . p_uart, NRF_UART_INT_MASK_RXDRDY | NRF_UART_INT_MASK_ERROR); nrf_uart_task_trigger(p_instance ->reg . p_uart, NRF_UART_TASK_STOPRX); }
...
#line 944 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
...
void UART0_IRQHandler(void)
{
    ...
    { uart_irq_handler(((NRF_UART_Type *) 0x40002000UL), &m_cb[0]); }
