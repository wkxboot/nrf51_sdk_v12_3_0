...
#line 42 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.h"
...
#line 44 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"
...
#line 45 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\common\\nrf_drv_common.h"
#line 46 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\common\\nrf_drv_common.h"
#line 47 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\common\\nrf_drv_common.h"
#line 48 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\common\\nrf_drv_common.h"
#line 49 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\common\\nrf_drv_common.h"
#line 50 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\common\\nrf_drv_common.h"





#line 68 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\common\\nrf_drv_common.h"
...
#line 162 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\common\\nrf_drv_common.h"
...
#line 186 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\common\\nrf_drv_common.h"
...
static __inline _Bool nrf_drv_common_irq_enable_check(IRQn_Type IRQn);
...
static __inline void nrf_drv_common_power_clock_irq_init(void);
...
static __inline void nrf_drv_common_power_clock_irq_init(void)
{
    if(!nrf_drv_common_irq_enable_check(POWER_CLOCK_IRQn))
    {
        nrf_drv_common_irq_enable(
            POWER_CLOCK_IRQn,
#line 335 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\common\\nrf_drv_common.h"
            3
...
#line 45 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"
...
#line 46 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"
#line 47 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\libraries\\util\\nrf_bitmask.h"
...
#line 46 "..\\..\\..\\..\\..\\..\\components\\libraries\\util\\nrf_bitmask.h"
#line 47 "..\\..\\..\\..\\..\\..\\components\\libraries\\util\\nrf_bitmask.h"
...
static __inline uint32_t nrf_bitmask_bit_is_set(uint32_t bit, void const * p_mask)
{
...
static __inline void nrf_bitmask_bit_set(uint32_t bit, void * p_mask)
{
...
static __inline void nrf_bitmask_bit_clear(uint32_t bit, void * p_mask)
{
    uint8_t * p_mask8 = (uint8_t *)p_mask;
    uint32_t byte_idx = ((bit)/8);
    bit = ((bit) & 0x00000007);
...
static __inline void nrf_bitmask_masks_or(void const *   p_mask1,
                                          void const *   p_mask2,
                                          void *         p_out_mask,
                                          uint32_t       length)
{
...
static __inline void nrf_bitmask_masks_and(void const *   p_mask1,
                                           void const *   p_mask2,
                                           void *         p_out_mask,
                                           uint32_t       length)
{
...
#line 48 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"
#line 49 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"
...
;enum { static_assert_63 = 1 / (! !((((((3)) == 1) || (((3)) == 3))))) };
...
#line 98 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"

#line 109 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"

 
typedef struct
{
    nrf_drv_gpiote_evt_handler_t handlers[4 + 4];
...
{
    return (m_cb.pin_assignments[pin] >= 4);
}
                                          ...
                                          _Bool                         is_channel)
{
    ...
    if (!is_channel)
    {
        m_cb.port_handlers_pins[channel_id - 4] = (int8_t)pin;
    }
}
...
static void channel_free(uint8_t channel_id)
{
    ...
    if (channel_id >= 4)
    {
        m_cb.port_handlers_pins[channel_id - 4] = (int8_t)(-1);
    }
}
...
void nrf_drv_gpiote_uninit(void)
{
    if (0) { if (m_cb . state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)270, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
...
ret_code_t nrf_drv_gpiote_out_init(nrf_drv_gpiote_pin_t                pin,
                                   nrf_drv_gpiote_out_config_t const * p_config)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)296, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (m_cb . state == NRF_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)297, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (p_config) { } else { assert_nrf_callback((uint16_t)298, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
...
void nrf_drv_gpiote_out_uninit(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)349, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)350, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
...
void nrf_drv_gpiote_out_set(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)365, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)366, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (!pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)367, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } }
...
void nrf_drv_gpiote_out_clear(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)375, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)376, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (!pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)377, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } }
...
void nrf_drv_gpiote_out_toggle(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)385, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)386, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (!pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)387, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } }
...
void nrf_drv_gpiote_out_task_enable(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)395, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)396, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)397, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } }
...
void nrf_drv_gpiote_out_task_disable(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)405, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)406, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)407, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } }
...
uint32_t nrf_drv_gpiote_out_task_addr_get(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)415, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)416, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
...
#line 435 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"

#line 448 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"

void nrf_drv_gpiote_out_task_force(nrf_drv_gpiote_pin_t pin, uint8_t state)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)451, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)452, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)453, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
...
void nrf_drv_gpiote_out_task_trigger(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)463, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)464, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)465, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
...
#line 485 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"

#line 499 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"

ret_code_t nrf_drv_gpiote_in_init(nrf_drv_gpiote_pin_t               pin,
                                  nrf_drv_gpiote_in_config_t const * p_config,
                                  nrf_drv_gpiote_evt_handler_t       evt_handler)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)504, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    ret_code_t err_code = ((0x0) + 0);
...
void nrf_drv_gpiote_in_event_enable(nrf_drv_gpiote_pin_t pin, _Bool int_enable)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)550, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use_by_gpiote(pin)) { } else { assert_nrf_callback((uint16_t)551, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (pin_in_use_by_port(pin))
    {
        uint8_t pin_and_sense =
            m_cb.port_handlers_pins[channel_port_get(pin) - 4];
        nrf_gpiote_polarity_t polarity =
...
void nrf_drv_gpiote_in_event_disable(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)595, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use_by_gpiote(pin)) { } else { assert_nrf_callback((uint16_t)596, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (pin_in_use_by_port(pin))
    {
...
void nrf_drv_gpiote_in_uninit(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)612, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use_by_gpiote(pin)) { } else { assert_nrf_callback((uint16_t)613, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
...
_Bool nrf_drv_gpiote_in_is_set(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)627, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
...
uint32_t nrf_drv_gpiote_in_event_addr_get(nrf_drv_gpiote_pin_t pin)
{
    if (0) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)634, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
    if (0) { if (pin_in_use_by_port(pin) || pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)635, (uint8_t *)"..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\gpiote\\nrf_drv_gpiote.c"); } };
