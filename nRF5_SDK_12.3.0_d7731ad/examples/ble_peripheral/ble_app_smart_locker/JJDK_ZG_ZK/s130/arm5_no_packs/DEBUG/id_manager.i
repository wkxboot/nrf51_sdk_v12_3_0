...
#line 42 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
#line 44 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"

#line 46 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
#line 47 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
#line 48 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
#line 49 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
#line 50 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
#line 51 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
#line 52 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
#line 53 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
                                  ...
                                  pm_peer_data_bonding_t const * p_bonding_data2)
{
    ...
    _Bool duplicate_addr = addr_compare(&p_bonding_data1->peer_ble_id.id_addr_info,
...
ret_code_t im_device_identities_list_set(pm_peer_id_t const * p_peers,
                                         uint32_t             peer_cnt)
{
#line 755 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
ret_code_t im_id_addr_set(ble_gap_addr_t const * p_addr)
{
        ...
        ret = address_set_v2(0x00, (ble_gap_addr_t *)p_addr);
        if (ret != ((0x0) + 0))
        {
            return ret;
        }

        if (   current_addr.addr_type == 0x02
            || current_addr.addr_type == 0x03)
        {
            
            
            ret = address_set_v2(0x01, &current_addr);
            if (ret != ((0x0) + 0))
            {
                return ret;
            }
...
ret_code_t im_privacy_set(pm_privacy_params_t const * p_privacy_params)
{
        ...
        if (p_privacy_params->privacy_mode == 0x00)
        {
            ret = address_set_v2(0x00, &m_current_id_addr);
        }
        else
        {
            ret = address_set_v2(0x01, &privacy_addr);
        }
...
ret_code_t im_privacy_get(pm_privacy_params_t * p_privacy_params)
{
        ...
        (void)(p_privacy_params != 0);
        (void)(p_privacy_params->p_device_irk != 0);
        ...
        if (   cur_addr.addr_type == 0x02
            || cur_addr.addr_type == 0x03)
        {
            p_privacy_params->privacy_mode      = 0x01;
            p_privacy_params->private_addr_type = cur_addr.addr_type;
        }
        else
        {
            p_privacy_params->privacy_mode = 0x00;
        }
...
#line 1020 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
